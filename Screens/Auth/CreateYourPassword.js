...
class CreateYourPassword extends React.Component {
    constructor(props){
        super(props)
    ...
    if(confirm_password_error || password_error || user_name_error || location_error || phone_error){
        this.setState({confirm_pass_error_state:confirm_password_error,pass_error_state:password_error,user_name_error_state:user_name_error,location_error_state:location_error,phone_error_state:phone_error})
        return false
    }
    ...
    create_password = ()=>{
        ...
        if(is_validate){
         this.setState({confirm_pass_error_state:'',pass_error_state:'',user_name_error_state:'',location_error_state:'',phone_error_state:'',next_loading:true})
    ...
    render() {
        ...
        <View  style={{ borderWidth:1,borderColor:this.state.location_error_state?'red':'white',borderRadius:5,width:Dimensions.get('window').width*2/2.2,marginTop:10,backgroundColor:'white',alignSelf:'center',}}>
            ...
            borderWidth:this.state.phone_error_state?2:1,} ]}
             ...
             <Text style={{ color:'red',textAlign:'center' }}>{this.state.phone_error_state}</Text>     
